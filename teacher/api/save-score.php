...
if (isset($_SESSION['teacher_id']) && isset($_SESSION['role'])) {
    ...
    if ($_SESSION['role'] == 'Teacher') {
        ...
        if (isset($_POST['score-1']) &&
            ...
            if(empty($student_id) || empty($subject_id) || empty($current_year) || empty($current_semester)){
                $em  = "Student ID, Subject ID, Year, and Semester are required";
            ...
            if(!empty($score_1) && !empty($aoutof_1)){
            ...
            if(!empty($score_2) && !empty($aoutof_2)){
                if($score_2 > 0 && $aoutof_2 > 0 && $score_2 <= $aoutof_2){
                    $data .= ",".$score_2." ".$aoutof_2;
                    $limit += $aoutof_2;
                } 
            }

            if(!empty($score_3) && !empty($aoutof_3)){
                if($score_3 > 0 && $aoutof_3 > 0 && $score_3 <= $aoutof_3){
                    $data .= ",".$score_3." ".$aoutof_3;
                    $limit += $aoutof_3;
                }
            }

            if(!empty($score_4) && !empty($aoutof_4)){
                if($score_4 > 0 && $aoutof_4 > 0 && $score_4 <= $aoutof_4){
                    $data .= ",".$score_4." ".$aoutof_4;
                    $limit += $aoutof_4;
                }
            }

            if(!empty($score_5) && !empty($aoutof_5)){
                if($score_5 > 0 && $aoutof_5 > 0 && $score_5 <= $aoutof_5){
